  ...
  $.fn.pluploadIt = function (options) {
    ...
    return this.each(function() {
      ...
      $('#' + settings.container + '-' + settings.upload_button).click(function(e) {
        ...
        // TODO: se eu coloar um id de um outro recurso, eu posto uma imagem lá
        // e não no recurso atual.
        $.extend(uploader.settings.multipart_params,
          {id: $attachmentUploader.attr('data-id')}
        );
